...
| **Shared Image Platform** | `src/components/shared/image/` (`ImageItem`, `ImageThumbnail`, `ImagePreview`, `ImageViewer`, `AttachmentResourceProvider`) | Shared image identity, thumbnail/preview/viewer state, transforms, signed-resource cache/retry | MQR, NTR, PM, Delivery/PDI; Vehicle360 remains |
...
| **Legacy Attachment Viewer** | `src/components/shared/attachments/AttachmentViewer.tsx` | Compatibility image/document viewer for not-yet-migrated consumers | Knowledge, Machine Passport |
...
- **In progress, Priority 1** — Issue #79, Platform Image Management:
  MQR, NTR, PM, and Delivery/PDI now consume the locked shared image platform.
  Vehicle360/Machine Passport remains. The adoption and deprecation
