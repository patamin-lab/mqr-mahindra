...
const superAdminSession = { username: 'root', fullName: 'Root', role: 'SuperAdmin' as const, dealerId: null, branch: null };
const dealerAdminSession = { username: 'bob', fullName: 'Bob', role: 'DealerAdmin' as const, dealerId: 'D1', branch: null };
const centralAdminSession = { username: 'carol', fullName: 'Carol', role: 'CentralAdmin' as const, dealerId: null, branch: null };
