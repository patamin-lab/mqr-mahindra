...
/** NTR's presentation adapter uses the existing authorized attachment route;
 * it does not access storage or change attachment ownership decisions. */
export function createNtrAttachmentResourceProvider(initialItems: readonly ImageItem[] = []): InMemoryAttachmentResourceProvider {
