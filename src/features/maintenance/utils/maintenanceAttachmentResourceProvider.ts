...
/** PM presentation adapter. Authorization and signed URL generation remain
 * owned by the existing attachment route/service. */
export function createMaintenanceAttachmentResourceProvider(initialItems: readonly ImageItem[] = []): InMemoryAttachmentResourceProvider {
