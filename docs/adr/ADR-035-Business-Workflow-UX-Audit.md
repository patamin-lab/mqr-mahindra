...
**Proposed. Audit only.** No code, schema, migration, API, or UI change.
Full findings in `docs/architecture/BUSINESS_WORKFLOW_UX_AUDIT.md`; this
ADR records the audit's existence, scope, and headline recommendations,
