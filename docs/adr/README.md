...
| ADR-039 | Shared Image Presentation and Editing Platform | **Accepted, implemented, locked** | Issue #79A.1 architecture refinement. Shared Image Platform v1 complete through PR #79L; see `docs/architecture/SHARED_IMAGE_PLATFORM_V1.md`. |
| ADR-040 | Image Metadata Foundation | **Proposed, design-only** | Epic #80 metadata architecture. No production code, schema, API, storage, viewer, or business-rule change. |

**Next available number: ADR-041.**
